...
for i = 1:nsamples
    u = rand(n,1);
    bs_atlantic = Finv(u,mu,beta);
    [bs_beta, bs_mu] = est_gumbel(bs_atlantic);
    bs_wave(i) = Finv(1 - 1/T, bs_mu, bs_beta); % wave dist by inverse
    bs_mus(i) = bs_mu;
    bs_betas(i) = bs_beta;
end
...
% Calculating one sided for 100 year return value
